...
// ============================================================================
// From: https://github.com/oleiade/lane/blob/master/priority_queue.go
// ============================================================================
...
// Len returns the number of elements present in the PriorityQueue.
func (pq *PriorityQueue[T, P]) Len() uint {
	pq.RLock()
	defer pq.RUnlock()
	return pq.size()
}
