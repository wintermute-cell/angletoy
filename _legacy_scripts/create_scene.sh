...
cp internal/scenes/scene_template.go "internal/scenes/scene_${some_name}.go"

# Replace all occurrences of "Template" with "SomeName" in the new file
sed -i "s/Template/$SomeName/g" "internal/scenes/scene_${some_name}.go"

echo "Processed template for $SomeName and saved to internal/scenes/scene_${some_name}.go"
